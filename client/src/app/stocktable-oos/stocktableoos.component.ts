...
@Component({
  selector: 'app-stocktable-oos',
  templateUrl: './stocktableoos.component.html',
  styleUrls: ['./stocktableoos.component.css']
})
export class StocktableOosComponent implements OnInit {
  EmptyEntries: number ;
  LowEntries: number ;
  AvgEntries: number ;
  TotalEntries: number ;
  ...
  ngOnInit(): void {
    ...
    this.http.get<StockData[]>('http://localhost:8082/stock/empty')
    .subscribe(Response => {
